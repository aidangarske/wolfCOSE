...
static const SubscriberInfo g_subscribers[NUM_SUBSCRIBERS] = {
    {
                                     ...
                                     size_t* macMsgLen, WC_RNG* rng)
{
    ...
    for (i = 0; i < NUM_SUBSCRIBERS; i++) {
        ...
        recipients[i].kid = g_subscribers[i].kid;
        recipients[i].kidLen = g_subscribers[i].kidLen;
                                        ...
                                        const uint8_t* macMsg, size_t macMsgLen)
{
    ...
    recipient.kid = g_subscribers[subscriberIndex].kid;
    recipient.kidLen = g_subscribers[subscriberIndex].kidLen;
...
static int tampered_message_detected(const uint8_t* macMsg, size_t macMsgLen)
{
    ...
    recipient.algId = WOLFCOSE_ALG_DIRECT;
    recipient.key = &subscriberKey;
    recipient.kid = g_subscribers[0].kid;
    recipient.kidLen = g_subscribers[0].kidLen;
