...
- COSE header maps accept unknown text labels and reject their duplicates.
  Registered COSE parameters remain numeric; `"alg"` is not an alias for
  integer label 1. `COSE_Key` maps always require integer labels.
